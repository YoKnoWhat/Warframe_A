...
int32 FAimState_Aiming::GetID()const
{
	return CastToUnderlyingType(EWarframeAimState::Aiming);
}

int32 FAimState_Aiming::OnUpdate(float DeltaTime)
{
...
void FAimState_Aiming::OnEnter(int32 StateFromID)
{
	UWarframeMovementComponent* CharacterMovement = Cast<UWarframeMovementComponent>(Character->GetCharacterMovement());
...
int32 FAimState_Idle::GetID()const
{
	return CastToUnderlyingType(EWarframeAimState::Idle);
}

int32 FAimState_Idle::OnUpdate(float DeltaTime)
{
	UWarframeStateMachineComponent* StateMachine = Cast<UWarframeStateMachineComponent>(Character->GetStateMachine());
...
void FAimState_Idle::OnEnter(int32 StateFromID)
{}

void FAimState_Idle::OnExit()
{}

int32 FAimState_Idle::OnCustomEvent(int32 EventID)
{
	return this->GetID();
}
